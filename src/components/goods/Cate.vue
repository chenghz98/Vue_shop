<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 表格区域 -->
      <tree-table :data="catelist" :columns="columns" :selection-type="false" show-index index-text="#" border :show-row-hover="false" class="treeTable" :expand-type="false">
        <!-- 是否有效 -->
    ...
    <el-dialog title="收货地址" :visible.sync="addCateDialogVisible" width="50%">
      <el-form :model="cateForm">
        ...
        <el-form-item label="活动区域" label-width="70px">
          <el-select v-model="cateForm.region" placeholder="请选择活动区域">
